                ...
                <div className='body'>
                    <div className='container'>
                        <div className='indicators'>
                            ...
                            <Amount focus={this.props.focus} amount={this.props.amount} target={this.props.target} subject={this.props.subject} operation={this.props.operation}/>
                        </div>
                        <IconButton onClick={this.handleShortButtonClick.bind(this)}><ArrowDropDown /></IconButton>
                    </div>
                    <div className={container}>
                        ...
                        />}
                        {this.state.shortForm? <></> : <IconButton onClick={this.handleNoteButtonClick.bind(this)}><Info variant='outlined'/></IconButton>}
                    </div>
                </div>
