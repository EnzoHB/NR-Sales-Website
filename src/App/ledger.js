...
ledger.get('Doações').to('Caixa').donate(110).reason('Initial investment');
ledger.get('João Pedro').to('Caixa').donate(6).reason('Initial Investment');
ledger.get('João Lucas').to('Caixa').lend(20).reason('Helping with more ingredients');
ledger.get('Enzo').to('Caixa').lend(13).reason('Helping with more ingredients');
ledger.get('Luísa').to('Caixa').lend(60).reason('Buying fruit juice');
ledger.stores.get('Supermercado São Luís').buyer('Caixa').cart('Ingredients').item('Leite Ninho (380g)').price(17.99).amount(1).item('Leite Condensado (295g)').price(7.49).amount(4).item('Creme de Leite (300g)').price(7.99).amount(5).item('Liga Neutra (100g)').price(5.99).amount(1).item('Leite (1L)').price(4.99).amount(8).item('Granulado (750g)').price(9.99).amount(1).pay();
...
ledger.get('Doações').to('Caixa').donate(60).reason('Helping the purchase of the products')
ledger.get('João Lucas').to('Caixa').lend(57).reason('Buying cash register. Payment Date: 18/03');
ledger.stores.get('Mercado Livre').buyer('Caixa').cart('Compra da caixa registradora').item('Caixa Registradora').price(57).amount(1).pay();
...
ledger.get('Caixa').to('Enzo').pay(50).reason('Could not pay for everything as I had already lent the money for the purchase of the pizzas')
ledger.get('Enzo').to('Caixa').donate(13.55).reason('Donating coins for extra change')
...
donations.many(...names.students).to('Doações').donate(10).reason('Initial Investment');
donations.many('João Lucas', 'Enzo', 'Julia', 'Eduardo', `Luísa`, 'Rian').to('Doações').donate(10).reason('Second Investment')
